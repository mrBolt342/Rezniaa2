...
namespace JUTPS.CrossPlataform
{
    ...
    public class MobileRig : MonoBehaviour
    {
        ...
        private void UpdateMobileButtons()
        {
            ...
            if (JUGameManager.PlayerController.IsDriving == false && EnterVehicleButton != null)
            {
                EnterVehicleButton.gameObject.SetActive(JUGameManager.PlayerController.ToEnterVehicle);
            }
        }
