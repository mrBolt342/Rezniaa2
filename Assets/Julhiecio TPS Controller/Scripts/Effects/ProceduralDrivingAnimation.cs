    ...
    public class ProceduralDrivingAnimation : JUTPSActions.JUTPSAction
    {
        ...
        protected virtual void DoProceduralDrivingAnimation(Vehicle Vehicle)
        {
            ...
            if (Vehicle.InverseKinematicTargetPositions.LeftFootPositionIK == null ||
               ...
               Vehicle.InverseKinematicTargetPositions.CharacterPosition == null)
            {
                return;
            }
            ...
            if (FootPlacer && Vehicle.AnimationWeights.FootPlacement)
            {
                ...
                Quaternion NewLeftFootRotation = Quaternion.Lerp(Quaternion.FromToRotation(LeftFootTargetPosition.up, LeftGroundHit.normal) * LeftFootTargetPosition.rotation, Vehicle.InverseKinematicTargetPositions.LeftFootPositionIK.rotation, vehicleSpeed / 5);
                Quaternion NewRightFootRotation = Quaternion.Lerp(Quaternion.FromToRotation(RightFootTargetPosition.up, RightGroundHit.normal) * RightFootTargetPosition.rotation, Vehicle.InverseKinematicTargetPositions.RightFootPositionIK.rotation, vehicleSpeed / 5);
