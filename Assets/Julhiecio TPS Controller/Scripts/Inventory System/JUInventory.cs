...
namespace JUTPS.InventorySystem
{
    ...
    public class JUInventory : MonoBehaviour
    {
      ...
      new SequentialSlot(SequentialSlotsEnum.tenth, null)};
        ...
        /// <summary>
        /// Return true if the <see cref="JUCharacter"/> is using a <see cref="HoldableItem"/> on any hand (left or right).
        /// </summary>
        ...
        /// <summary>
        /// Return true if the <see cref="JUCharacter"/> is using a <see cref="HoldableItem"/> on left and right hand.
        /// </summary>
        ...
        /// <returns></returns>
        public Item GetItem(int globalID) { return AllItems[globalID]; }
        ...
        /// <returns></returns>
        public static Item GetItem(JUInventory inventory, string itemName)
        {
            Item itemToReturn = null;
            foreach (Item currentItem in inventory.AllItems)
            {
                if (currentItem.ItemName == itemName || currentItem.name == itemName)
                {
                    itemToReturn = currentItem;
